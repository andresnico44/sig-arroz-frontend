...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F4F9F6] via-[#FAFDFB] to-[#F0F5F2] text-gray-800 overflow-x-hidden font-sans selection:bg-emerald-500 selection:text-white relative">
      {/* Luces y brillos de fondo decorativos en tono claro */}
      <div className="absolute top-[10%] left-[-10%] w-[500px] h-[500px] bg-emerald-200/20 rounded-full filter blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-[20%] right-[-10%] w-[600px] h-[600px] bg-green-200/20 rounded-full filter blur-[150px] pointer-events-none"></div>
      <div className="absolute top-[40%] right-[10%] w-[300px] h-[300px] bg-amber-200/10 rounded-full filter blur-[100px] pointer-events-none"></div>

      {/* 1. Navbar Sticky con Efecto de Cristal en Tono Claro */}
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-[#FAFDFB]/80 border-b border-emerald-100/80 shadow-sm transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-black tracking-tight text-[#0D1A12] flex items-center gap-1.5">
              SIG-ARROZ
              <span className="text-xs font-bold text-[#b8952b] px-1.5 py-0.5 rounded-md bg-[#D4AF37]/10 border border-[#D4AF37]/20">
                V3.0
              </span>
            </span>
          </div>
      ...
      <header className="max-w-7xl mx-auto px-6 py-12 md:py-20 lg:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        >
          ...
          <motion.h1 
            variants={itemVariants}
            className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-[#0D1A12] leading-[1.1]"
          >
            Inteligencia Agronómica <br />
            y Financiera <br />
            <span className="bg-gradient-to-r from-emerald-600 via-green-600 to-[#b8952b] bg-clip-text text-transparent">
          ...
          <motion.p 
            variants={itemVariants}
            className="text-base sm:text-lg text-gray-600 max-w-xl font-medium leading-relaxed"
          >
          ...
          <motion.div 
            variants={itemVariants}
            className="pt-8 border-t border-emerald-100 grid grid-cols-3 gap-6 max-w-lg"
          >
            <div>
              <p className="text-3xl font-black text-[#b8952b] tracking-tight">+25%</p>
              <p className="text-xs text-gray-500 font-semibold mt-1">Productividad Promedio</p>
            </div>
            <div>
              <p className="text-3xl font-black text-emerald-600 tracking-tight">-15%</p>
              <p className="text-xs text-gray-500 font-semibold mt-1">Costo de Insumos</p>
            </div>
            <div>
              <p className="text-3xl font-black text-gray-700 tracking-tight">100%</p>
        ...
        >
          <div className="relative group">
            ...
            <div className={`absolute -inset-0.5 rounded-3xl blur-xl opacity-20 transition-all duration-500 ${
            ...
            <div className="relative bg-white border border-emerald-100 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-emerald-50">
                ...
                <div className="w-8 h-8 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center">
                  <Leaf className={`w-4 h-4 transition-colors ${isApt ? 'text-emerald-600' : 'text-red-500'}`} />
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                />
                <div className="flex justify-between text-2xs text-gray-400 font-bold">
                  <span>4.0 (Ácido)</span>
              ...
              <AnimatePresence mode="wait">
                {!isApt ? (
                  <motion.div 
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="p-4 rounded-2xl bg-red-50 border border-red-100 flex gap-3 text-sm"
                  >
                  ...
                  <motion.div 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className="p-4 rounded-2xl bg-emerald-50 border border-emerald-100 flex gap-3 text-sm"
                  >
                ...
                <AnimatePresence>
                  {showSeedAnim && (
                    <motion.div 
                      ...
                      className="mt-4 pt-4 border-t border-emerald-50 flex flex-col items-center justify-center text-center space-y-2 bg-[#F8FAF9] rounded-2xl p-4 border border-emerald-100"
                    >
                      <div className="relative w-16 h-16 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center overflow-hidden shadow-inner">
                        ...
                        >
                          <Sprout className="w-10 h-10 text-emerald-600 drop-shadow-[0_2px_4px_rgba(16,185,129,0.2)]" />
                        </motion.div>
                        <div className="absolute bottom-0 w-full h-3 bg-amber-950/20 border-t border-amber-900/10"></div>
                      </div>
                      <div>
                        <p className="text-xs font-black text-[#b8952b] tracking-tight">¡Semilla Germinada con Éxito!</p>
      ...
      {/* 3. Features Section (Estilo Cristal Tono Claro) */}
      <section className="max-w-7xl mx-auto px-6 py-20 relative z-10 border-t border-emerald-100">
        <div className="text-center max-w-2xl mx-auto space-y-4 mb-16">
          <h2 className="text-xs font-extrabold text-emerald-600 uppercase tracking-widest">Características Destacadas</h2>
          <h3 className="text-3xl sm:text-4xl font-black text-[#0D1A12] tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-emerald-100 hover:border-emerald-300 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1.5 group">
            ...
            <h4 className="text-lg font-black text-[#0D1A12] mb-3">Análisis de Suelos Dinámico</h4>
          ...
          <div className="bg-white border border-emerald-100 hover:border-emerald-300 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1.5 group">
            ...
            <h4 className="text-lg font-black text-[#0D1A12] mb-3">Bitácora de Campo de Precisión</h4>
            <p className="text-xs sm:text-sm text-gray-500 leading-relaxed font-medium">
          ...
          <div className="bg-white border border-emerald-100 hover:border-emerald-300 rounded-3xl p-8 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1.5 group">
            ...
            <h4 className="text-lg font-black text-[#0D1A12] mb-3">Billetera Contable del Cultivo</h4>
            <p className="text-xs sm:text-sm text-gray-500 leading-relaxed font-medium">
      ...
      <footer className="max-w-7xl mx-auto px-6 py-12 border-t border-emerald-100 flex flex-col md:flex-row items-center justify-between text-xs font-medium text-gray-400 gap-4 relative z-10">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-emerald-50 rounded-lg border border-emerald-100 flex items-center justify-center">
            <Tractor className="w-3 h-3 text-emerald-600" />
          </div>
          <span className="font-bold text-[#0D1A12]">SIG-ARROZ</span>
        </div>
        <p>© 2026 SIG-ARROZ. Todos los derechos reservados. Agricultura de precisión y eficiencia contable.</p>
        <div className="flex gap-4">
          <Link to="/login" className="hover:text-emerald-600 transition-colors">Iniciar Sesión</Link>
          <span>•</span>
          <Link to="/register" className="hover:text-emerald-600 transition-colors">Registrarse</Link>
        </div>
      </footer>
    </div>
  );
